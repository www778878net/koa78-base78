...
whenToUse: "当需要执行发布流程，包括 git 提交、更新版本号时使用"
model: "GLM-4.7"
...
- **自动推送** - 通过 postversion hook 自动推送标签到远程
