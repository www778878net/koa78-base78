...
const sqlite_database_agent_1 = require("../../workflow/agents/sqlite-database-agent");
...
function runSqliteAgentDemo() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        // 创建SQLite数据库服务Agent
        const sqliteAgent = new sqlite_database_agent_1.SqliteDatabaseAgent();
        yield sqliteAgent.initializeConnection('default', {
...
function main() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        console.log('='.repeat(60));
        yield runSqliteAgentDemo();
        console.log('\n演示结束');
    });
}
// 启动演示
main().catch(console.error);
//# sourceMappingURL=sqlite-agent-demo.js.map