...
function runConditionalWorkflowDemo() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        // 任务1: 检查数值
        const checkValueTask = new task_1.Task({
            id: 'check-value',
            taskname: '检查数值',
            state: 'pending',
            priority: 1
        });
        checkValueTask.taskFunction = (input) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { value } = input;
            console.log(`\n🔍 检查数值: ${value}`);
            if (value > 5) {
                return {
        ...
        // 任务2: 大数值处理
        const largeValueTask = new task_1.Task({
            id: 'process-large',
            taskname: '处理大数值',
            state: 'pending',
            priority: 2
        });
        largeValueTask.taskFunction = (input) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            console.log(`\n📈 处理大数值: ${input.value}`);
            return Object.assign(Object.assign({}, input), { processed: true, handler: 'large' });
        });
        // 任务3: 小数值处理
        const smallValueTask = new task_1.Task({
            id: 'process-small',
            taskname: '处理小数值',
            state: 'pending',
            priority: 2
        });
        smallValueTask.taskFunction = (input) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            console.log(`\n📉 处理小数值: ${input.value}`);
            return Object.assign(Object.assign({}, input), { processed: true, handler: 'small' });
        });
        // 任务4: 平方计算
        const squareTask = new task_1.Task({
            id: 'calculate-square',
            taskname: '计算平方',
            state: 'pending',
            priority: 3
        });
        squareTask.taskFunction = (input) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            console.log(`\n🔢 计算平方: ${input.value}² = ${input.value * input.value}`);
            return Object.assign(Object.assign({}, input), { squared: input.value * input.value });
        });
        // 任务5: 结果格式化
...
function main() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        yield runConditionalWorkflowDemo();
        console.log('\n' + '='.repeat(60));
...
//# sourceMappingURL=conditional-workflow-demo.js.map