...
// 设置参数验证器的回调函数
paramValidatorHandler.setCallback((result, params) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
// 设置数据库查询的回调函数
dbQueryHandler.setCallback((result, params) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
...
// 测试执行处理器的函数
function testExecuteHandler() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        console.log('=== 测试参数验证器 ===');
        try {
            // 测试成功的情况
            const validationResult = yield agent.executeHandlerByCapability('validator', 'validate', { sid: 'session-123' });
            console.log('验证结果:', validationResult);
            // 测试失败的情况
            const invalidResult = yield agent.executeHandlerByCapability('validator', 'validate', {});
        ...
        console.log('\n=== 测试数据库查询 ===');
        try {
            const queryResult = yield agent.executeHandlerByCapability('query', 'query', { sid: 'session-123' });
