...
exports.AuthServiceAgent = void 0;
...
class AuthServiceAgent extends agent_1.Agent {
    constructor() {
        super(); // 调用父类的构造函数
        this.databaseAgent = null;
        this.cacheServiceAgent = null;
    }
    // 初始化方法，用于设置依赖项
    init(databaseAgent, cacheServiceAgent) {
    ...
    upcheck(up, cols, dbname) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            // 使用CacheServiceAgent
            let tmp = (yield ((_a = this.cacheServiceAgent) === null || _a === void 0 ? void 0 : _a.tbget(mem_sid + dbname + up.sid, up.debug))) || null;
            if (tmp === "pool null")
                tmp = "";
            if (!tmp) {
                let cmdtext = `
            ...
            `;
                ...
                const result = (yield ((_b = this.databaseAgent) === null || _b === void 0 ? void 0 : _b.query(cmdtext, values, up, dbname))) || [];
                console.log("upcheck result:", result);
                if ((result === null || result === void 0 ? void 0 : result.length) === 0)
                    tmp = "";
                else {
                    tmp = result[0];
                    yield ((_c = this.cacheServiceAgent) === null || _c === void 0 ? void 0 : _c.tbset(mem_sid + dbname + up.sid, tmp));
                }
            }
            if (tmp) {
                up.uid = tmp["id"];
    ...
    preventReplayAttack(up) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const existingCache = (yield ((_a = this.cacheServiceAgent) === null || _a === void 0 ? void 0 : _a.get(cacheKey))) || null;
            if (existingCache) {
                throw new Error("防止重放攻击" + cacheKey);
            }
            yield ((_b = this.cacheServiceAgent) === null || _b === void 0 ? void 0 : _b.set(cacheKey, 1, 2));
        });
    }
}
exports.AuthServiceAgent = AuthServiceAgent;
AuthServiceAgent._CID_MY = null;
AuthServiceAgent.CID_GUEST = "GUEST000-8888-8888-8888-GUEST00GUEST";
//# sourceMappingURL=auth-service-agent.js.map