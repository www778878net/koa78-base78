...
function testExecuteHandler() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        try {
            // 测试成功的情况
            const validationResult = yield agent.executeHandler('validator', 'validate', { sid: 'session-123' });
            console.log('验证结果:', validationResult);
            // 测试失败的情况
            const invalidResult = yield agent.executeHandler('validator', 'validate', {});
        ...
        console.log('\n=== 测试数据库查询 ===');
        try {
            const queryResult = yield agent.executeHandler('query', 'query', { sid: 'session-123' });
