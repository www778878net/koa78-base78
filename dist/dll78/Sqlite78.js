...
class Sqlite78 {
    ...
    initialize() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this._db = new sqlite3_1.default.Database(this._filename);
                // 启用外键约束
                yield this._run('PRAGMA foreign_keys = ON');
                // 设置WAL模式以提高并发性能
                yield this._run('PRAGMA journal_mode = WAL');
    ...
    doT(cmds, values, errtexts, logtext, logvalue, up) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                // 开始事务
                yield this._run('BEGIN TRANSACTION');
                const results = [];
                for (let i = 0; i < cmds.length; i++) {
                    const result = yield this._run(cmds[i], values[i]);
                    results.push(result);
                }
                let errmsg = "err!";
                let haveAff0 = false;
    ...
    close() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (this._db) {
                ...
                const closeAsync = (0, util_1.promisify)(this._db.close.bind(this._db));
                yield closeAsync();
            }
        });
    }
